...
Revision ID: 4fb9b33f8fa8
Revises: 
Create Date: 2025-07-16 14:42:37.818762
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('state_id', sa.String(length=2), nullable=False),
    sa.Column('role_id', sa.Enum('VOLUNTEER', 'ADMIN', 'PENDING_APPROVAL', name='user_roles'), nullable=False),
    ...
    sa.Column('preferences', sa.String(length=512), nullable=True),
    sa.ForeignKeyConstraint(['state_id'], ['states.state_id'], ),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user_credentials.user_id'], ),
    sa.PrimaryKeyConstraint('user_id', 'availability_date')
    )
